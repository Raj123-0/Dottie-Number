...
Calculates Dottie Number to an arbitrary precision of [N] significant digits using a highly optimized 12-core parallelized algorithm.
...
```bash
python "Dottie Number.py" -n 1000
```
